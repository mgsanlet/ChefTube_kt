...
interface UsersRepository {
    ...
    suspend fun loginUser(emailOrUsername: String, password: String): DomainResult<Unit, UserError>
    ...
    fun getCurrentUserCopy(): DomainResult<User, UserError>
    fun alternateKeepSession(keep: Boolean): DomainResult<Unit, UserError>
    fun isSessionKept(): DomainResult<Boolean, UserError>
    fun logout()
}